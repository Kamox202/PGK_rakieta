...
//  const ballMat = new THREE.MeshBasicMaterial({Wireframe: true, color: 0x555555});
...
//  const mat = new THREE.PointsMaterial({ size: 1,color: 0xFFFF00 ,vertexColors: false });
...
var trailMaterial = TrailRenderer.createBaseMaterial({ color: 0xFF0100 } );	

// specify length of trail
var trailLength = 150;

// initialize the trail
trail.initialize( trailMaterial, trailLength, false, 0, sfera, mercury  );
