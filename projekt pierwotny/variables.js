...
const predkosc_tab = [v_mercury, v_venus, v_earth, v_mars, v_jupiter, v_saturn, v_uran, v_neptun];
const odleglosc_tab = [d_mercury, d_venus, d_earth, d_mars, d_jupiter, d_saturn, d_uran, d_neptun];
